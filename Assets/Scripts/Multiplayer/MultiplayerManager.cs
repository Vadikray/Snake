...
public class MultiplayerManager : ColyseusManager<MultiplayerManager>
{
    ...
    private const string GamaRoomName = "state_handler";
    ...
    private async void Connection()
    {
        ...
        _room = await client.JoinOrCreate<State>(GamaRoomName, data);
    ...
    private void RemoveEnemy(string key, Player value)
    {
        ...
        {
            Debug.LogError("Попытка уничтожить еними, которого не было в словаре");
            return;
        }
